        ...
        <div className="settings-content">
          ...
          <div className="settings-section">
            ...
            <div className="setting-item">
              ...
              <select id="theater-cover-style" defaultValue={settings.theaterCoverStyle || "horizontal"}>
                <option value="horizontal">Horizontal (Landscape)</option>
                <option value="vertical">Vertical (Portrait)</option>
              </select>
              <span className="setting-description">Choose between horizontal thumbnails or vertical movie posters</span>
            </div>
            <div className="setting-item">
              <label htmlFor="theater-layout-density">Layout Density</label>
              <select id="theater-layout-density" defaultValue={settings.theaterLayoutDensity || "comfortable"}>
                <option value="comfortable">Comfortable (More spacing)</option>
                <option value="compact">Compact (Standard spacing)</option>
                <option value="dense">Dense (Less spacing)</option>
              </select>
              <span className="setting-description">Adjust spacing between content cards</span>
            </div>
            <div className="setting-item">
              <label htmlFor="theater-show-progress">Show Progress Bars</label>
              <input type="checkbox" id="theater-show-progress" defaultChecked={settings.theaterShowProgress !== false} />
              <span className="setting-description">Display progress bars for partially watched videos</span>
            </div>
            <div className="setting-item">
              <label htmlFor="theater-auto-play-trailers">Auto-play Trailers</label>
              <input type="checkbox" id="theater-auto-play-trailers" defaultChecked={settings.theaterAutoPlayTrailers || false} />
              <span className="setting-description">Automatically play video previews on hover</span>
            </div>
          </div>
